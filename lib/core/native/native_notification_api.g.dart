...
class NativeNotificationApi {
  /// Constructor for [NativeNotificationApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  NativeNotificationApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<void> showNotification(NotificationPayload payload) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.flutter_posts.NativeNotificationApi.showNotification$pigeonVar_messageChannelSuffix';
